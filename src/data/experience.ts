...
export const experienceData: Experience[] = [
  {
    ...
    description: [
      ...
      "Optimized front-end rendering performance and database queries, cutting response time by 35%.",
    ],
    technologies: ["Next.js", "TypeScript", "Laravel", "Tailwind CSS", "MySQL"],
  },
  {
    company: "Digital Crafts Agency",
    ...
    technologies: ["Flutter", "Dart", "REST APIs", "Git"],
  },
];